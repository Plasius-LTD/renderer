# Contributing to @plasius/renderer
...
`@plasius/renderer` provides 3D renderer components for Plasius projects with XR session integration hooks.

Contributions typically fall into rendering primitives, camera and XR integration, public package docs, tests, and tooling quality.
